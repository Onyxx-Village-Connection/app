  ...
  whichTwo(
    ...
    return FutureBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        Iterable<QueryDocumentSnapshot<Object?>> orders =
                  ...
                  child: TextButton(
                    ...
                    style: ButtonStyle(
                      overlayColor: MaterialStateProperty.resolveWith<Color>(
                        ...
                        return Color(
                            0xFFE0CB8F); // Defer to the widget's default.
                      }),
                      shape: MaterialStateProperty.all(
                        RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(10.0),
                            side:
                                BorderSide(color: Color(0xFFE0CB8F), width: 2)),
                      ),
                    ...
                    child: ListBody(
                      children: [
                        Text(
                            ...
                            style: TextStyle(
                                fontSize: 18,
                                color: CustomTheme.getLight()
                                    ? Colors.black
                                    : Colors.white)),
                      ], //_LogHoursState._total.toString()
                    ),
                  )),
            ),
          ],
          ...
          Expanded(
            child: Container(
                ...
                child: TextButton(
                  ...
                  child: ListBody(
                    children: [
                      Text("You have 0 previous pickups",
                          style: TextStyle(
                              fontSize: 18,
                              color: CustomTheme.getLight()
                                  ? Colors.black
          ...
          Expanded(
            child: Container(
                ...
                child: TextButton(
                  ...
                  child: ListBody(
                    children: [
                      Text("You have 0 previous deliveries",
                          style: TextStyle(
                              fontSize: 18,
                              color: CustomTheme.getLight()
                                  ? Colors.black
...
Widget organize(BuildContext context, int number, String which, String widg,
    Volunteer volunteer) {
  Widget returning = new Container();
  if (widg == "pickup") {
    returning = Row(
              ...
              child: TextButton(
                onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            NamesDates().whichWidg(number, widg, volunteer)),
                  );
                },
                style: ButtonStyle(
                  overlayColor: MaterialStateProperty.resolveWith<Color>(
                ...
                child: ListBody(
                  children: [
                    Text(
                        Volunteer.returnVolunteersPickups(volunteer)
                            .elementAt(
                                Volunteer.returnVolunteersPickups(volunteer)
                                        .length -
                                    number)
                  ...
                  children: [
                    Text(
                        volunteer
                            ...
                            .elementAt(
                                volunteer.getVolunteerDeliveries().length -
                                    number)
                            .getName(),
                        style: TextStyle(
                          fontSize: 18,
...
class NamesDates extends StatelessWidget {
  Widget whichWidg(int num, String whichWidget, Volunteer volunteer) {
    Widget returning = IndividualPickup(
      num: num,
      volunteer: volunteer,
    );
    if (whichWidget == "pickup") {
      returning = IndividualPickup(
        num: num,
        volunteer: volunteer,
      );
    }
    if (whichWidget == "delivery") {
      returning = IndividualDelivery(
        num: num,
        volunteer: volunteer,
      );
    }
